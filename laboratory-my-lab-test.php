                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="laboratory-my-lab-test.php" class="cial-sidebar-menu-link active">
                                ...
                                <div class="col col-12 col-md-6 col-lg-6 col-xl-4">
                                    <div class="ciam-appointment-card">
                                        <div class="ciam-appointment-card-body">
                                            ...
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Lab Test Details</span>
                                            </p>
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Lab Test Name :</span>
                                                <span class="ciam-card-details-text">Name</span>
                                            </p>
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Lab Test Result :</span>
                                                <span class="ciam-card-details-text">Result</span>
                                            </p>
                                            <p class="ciam-card-details">
