                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="pharmacy-stock-upload.php" class="cial-sidebar-menu-link active">
            ...
            <div class="col col-12 col-md-12 col-lg-8">
                <div class="ciam-dashboard-content">
                    <div class="ciam-dashboard-content__inner ciam-shop-medicine-content">
                            ...
                            <div class="col col-12 col-md-6 col-lg-6 col-xl-4">
                                <div class="ciam-slide-card ciam-product-card">
                                    ...
                                    <div class="ciam-slide-card-body">
                                        ...
                                        <p class="ciam-product-price"><span>Stocks :</span> 50</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col col-12 col-md-6 col-lg-6 col-xl-4">
                        ...
                        <div class="text-center ciam-btn-fileInput">
                            <div class="ciam-fileInput">
                                <input type="file" class="form-control">
                                <span class="ciam-fileInput-text">Update the stock ( Upload CSV file )</span>
                            </div>
                        </div>
                    </div>
                </div>
