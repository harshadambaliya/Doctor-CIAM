                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="my-order.php" class="cial-sidebar-menu-link active">
            ...
            <div class="col col-12 col-md-12 col-lg-8">
                <div class="ciam-dashboard-content">
                    <div class="ciam-dashboard-content__inner">
                        <div class="ciam-order-content">
                            <div class="row">
                                <div class="col col-12 col-md-12 col-lg-12">
                                    <div class="ciam-order-card">
                                        <div class="ciam-order-card-heading">
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Order Id :</span>
                                                <span class="ciam-card-details-text">9956328</span>
                                            </p>
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Order Date :</span>
                                                <span class="ciam-card-details-text">23 Sep 2021</span>
                                            </p>
                                        </div>
                                        <div class="ciam-order-card-body">
                                            <span class="ciam-order-card-title">Product Name</span>
                                            <div class="row">
                                                <div class="col col-12 col-md-6 col-lg-4">
                                                    ...
                                                    <p class="ciam-card-details">
                                                        <span class="ciam-card-details-title">Payment status :</span>
                                                        <span class="ciam-card-details-text">Paid</span>
                                                    </p>
                                                    <p class="ciam-card-details">
                                                        <span class="ciam-card-details-title">Delivery address :</span>
                                                        <span class="ciam-card-details-text">address</span>
                                                    </p>
                                                </div>
                                                <div class="col col-12 col-md-6 col-lg-4">
                                                    <p class="ciam-card-details">
                                                        <span class="ciam-card-details-title">Order Status :</span>
                                                        <span class="ciam-card-details-text">Delivered</span>
                                                    </p>
                                                    <p class="ciam-card-details">
                                                        <span class="ciam-card-details-title">Oder Details :</span>
                                                        <span class="ciam-card-details-text">details</span>
                                                    </p>
                                                    <p class="ciam-card-details">
