                    ...
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-profile.php" class="cial-sidebar-menu-link active">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="ciam-completed-assignment.php" class="cial-sidebar-menu-link">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-billing-segment.php" class="cial-sidebar-menu-link">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-account-setting.php" class="cial-sidebar-menu-link">
                ...
                <div class="ciam-dashboard-content">
                    <div class="ciam-dashboard-content__inner">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="clinicInfo-tab" data-bs-toggle="tab" data-bs-target="#clinicInfo" type="button" role="tab" aria-controls="clinicInfo" aria-selected="false">Clinic Info</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="profileTabContent">
                                ...
                                <div class="ciam-tab-content">
                                    <form class="row g-3">
                                        ...
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" id="inputSpecialty" placeholder="Specialty">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputSpecialtySubcategory" class="form-label">Specialty - Subcategory</label>
                                            <input type="text" class="form-control" id="inputSpecialtySubcategory" placeholder="Specialty - Subcategory">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                        ...
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputLanguageSpoken" class="form-label">Language Spoken</label>
                                            <input type="text" class="form-control" id="inputLanguageSpoken" placeholder="Language Spoken">
                                        </div>
                                        <div class="col col-12 col-md-12 col-lg-12">
                                            <label for="inputYearsExperience" class="form-label">Total years of experience</label>
                                            <input type="number" class="form-control" id="inputYearsExperience" placeholder="Total years of experience">
                                        </div>
                                        <div class="col col-12 col-md-12 col-lg-12">
                                            <label for="inputAbout Me" class="form-label">About Me</label>
                                            <textarea  class="form-control" name="" id="inputAbout Me" rows="4" placeholder="About Me"></textarea>
                                        </div>
                                        <div class="col col-12 col-md-12 col-lg-12">
                            ...
                            <div class="tab-pane fade" id="clinicInfo" role="tabpanel" aria-labelledby="clinicInfo-tab">
                                <div class="ciam-tab-content">
                                    <form class="row g-3">
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputClinicName" class="form-label">Clinic Name</label>
                                            <input type="text" class="form-control" id="inputClinicName" placeholder="Clinic Name">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputLocationclinic" class="form-label">Location of clinic</label>
                                            <input type="text" class="form-control" id="inputLocationclinic" placeholder="Location of clinic">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputFromToDays" class="form-label">From to To days</label>
                                            <input type="text" class="form-control" id="inputFromToDays" placeholder="From to To days">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputOpenTime" class="form-label">Open Time</label>
                                            <input type="text" class="form-control" id="inputOpenTime" placeholder="Open Time">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputCloseTime" class="form-label">Close Time</label>
                                            <input type="text" class="form-control" id="inputCloseTime" placeholder="Close Time">
                                        </div>
                                        <div class="col col-12 col-md-6 col-lg-6">
                                            <label for="inputOfflineConsultancyFees" class="form-label">Offline Consultancy Fees</label>
                                            <input type="text" class="form-control" id="inputOfflineConsultancyFees" placeholder="Offline Consultancy Fees">
                                        </div>
                                        <div class="col col-12 col-md-12 col-lg-12">
                                            <label for="inputDoctorAvailabilityStatus" class="form-label">Doctor’s availability status</label>
                                            <input type="number" class="form-control" id="inputDoctorAvailabilityStatus" placeholder="Doctor’s availability status">
                                        </div>
                                        <div class="col col-12 col-md-12 col-lg-12 text-center">
                                            <button type="submit" class="btn btn-primary w-100">Update</button>
                                        </div>
