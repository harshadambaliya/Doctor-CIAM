                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="pharmacy-account-setting.php" class="cial-sidebar-menu-link active">
                ...
                <div class="ciam-dashboard-content">
                    <div class="ciam-dashboard-content__inner">
                        <form class="row g-3">
                            ...
                            <div class="col col-12 col-md-12 col-lg-12">
                                <label for="inputEnterNewPassword" class="form-label">Payment gateway ID</label>
                                <input type="text" class="form-control" id="inputEnterNewPassword" placeholder="Enter payment gateway ID">
                            </div>
                            <div class="col col-12 col-md-12 col-lg-12">
