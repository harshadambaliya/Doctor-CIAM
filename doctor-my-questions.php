                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-my-questions.php" class="cial-sidebar-menu-link active">
                    ...
                    <div class="ciam-dashboard-content__inner">
                        <div class="ciam-review-content">
                            <div class="text-end mb-3">
                                <a href="#" class="btn btn-primary">Give Answer</a>
                            </div>
                            <div class="row">
                                <div class="col col-12 col-md-12 col-lg-12">
                                    <div class="ciam-review-card">
                                        <div class="ciam-review-card-heading">
                                            <h3 class="ciam-review-user-title">Lorem Ipsum is simply dummy text ?</h3>
                                        </div>
