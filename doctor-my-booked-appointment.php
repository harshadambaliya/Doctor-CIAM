                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-my-booked-appointment.php" class="cial-sidebar-menu-link active">
                                ...
                                <div class="col col-12 col-md-6 col-lg-4">
                                    <div class="ciam-appointment-card">
                                        ...
                                        <div class="ciam-appointment-card-body">
                                            ...
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Status of Booking :</span>
                                                <span class="ciam-card-details-text">Pending</span>
                                            </p>
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Location :</span>
                                                <span class="ciam-card-details-text">Location, India</span>
                                            </p>
                                            <p class="ciam-card-details">
                                            ...
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">View document :</span>
