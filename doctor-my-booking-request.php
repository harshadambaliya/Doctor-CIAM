                ...
                <div class="ciam-dashboard-sidebar">
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="doctor-my-booking-request.php" class="cial-sidebar-menu-link active">
                                ...
                                <div class="col col-12 col-md-6 col-lg-4">
                                    <div class="ciam-appointment-card ciam-booking-request-card">
                                        <div class="ciam-appointment-card-body">
                                            ...
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Booking of :</span>
                                                <span class="ciam-card-details-text">video consult</span>
                                            </p>
                                            <p class="ciam-card-details">
                                                <span class="ciam-card-details-title">Booking time :</span>
                                                <span class="ciam-card-details-text">time</span>
                                            </p>
                                        </div>
