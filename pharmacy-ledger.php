                    ...
                    <div class="ciam-dashboard-sidebar-heading">
                        ...
                        <ul class="cial-sidebar-menu-list">
                            <li class="cial-sidebar-menu-item">
                                <a href="pharmacy-my-medicine-order-request.php" class="cial-sidebar-menu-link ">
                            ...
                            <li class="cial-sidebar-menu-item">
                                <a href="pharmacy-ledger.php" class="cial-sidebar-menu-link active">
                        ...
                        <div class="ciam-wallet-content">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="invoiceIssued-tab" data-bs-toggle="tab" data-bs-target="#invoiceIssued" type="button" role="tab" aria-controls="invoiceIssued" aria-selected="true">Invoice issued</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="receivedFromCaim-tab" data-bs-toggle="tab" data-bs-target="#receivedFromCaim" type="button" role="tab" aria-controls="receivedFromCaim" aria-selected="false">Received from Caim</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="chargedByCaim-tab" data-bs-toggle="tab" data-bs-target="#chargedByCaim" type="button" role="tab" aria-controls="chargedByCaim" aria-selected="false">Charged by Caim</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="amountReceivable-tab" data-bs-toggle="tab" data-bs-target="#amountReceivable" type="button" role="tab" aria-controls="amountReceivable" aria-selected="false">Amount receivable</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="profileTabContent">
                                <div class="tab-pane fade show active" id="invoiceIssued" role="tabpanel" aria-labelledby="invoiceIssued-tab">
                                ...
                                <div class="tab-pane fade" id="receivedFromCaim" role="tabpanel" aria-labelledby="receivedFromCaim-tab">
                                    <div class="ciam-tab-content">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                ...
                                <div class="tab-pane fade" id="chargedByCaim" role="tabpanel" aria-labelledby="chargedByCaim-tab">
                                    <div class="ciam-tab-content">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                ...
                                <div class="tab-pane fade" id="amountReceivable" role="tabpanel" aria-labelledby="amountReceivable-tab">
                                    <div class="ciam-tab-content">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
